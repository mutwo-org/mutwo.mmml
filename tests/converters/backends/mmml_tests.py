...
class MMMLSinglePitchConverterTest(unittest.TestCase):
    def test_convert_via_decodex_dict(self):
        ...
        self.assertEqual(
            ...
            parameters.pitches.WesternPitch("b", 3),
        )
        self.assertEqual(
            converter.convert("f"),
    ...
    def test_convert_via_decodex_function(self):
        ...
        self.assertEqual(
            ...
            parameters.pitches.DirectPitch(200),
        )
        self.assertEqual(
            converter.convert("300:1"),
            parameters.pitches.DirectPitch(600),
        )
        self.assertEqual(
            converter.convert("400.5"),
            parameters.pitches.DirectPitch(400.5),
        )
        self.assertEqual(
            converter.convert("1000:-1"),
            parameters.pitches.DirectPitch(500),
        )
        self.assertEqual(
            converter.convert(backends.mmml_constants.REST_IDENTIFIER),
            None,
